        ...
        >
          ...
          >
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between gap-3 backdrop-blur-[30px] border border-white/10 pointer-events-auto"
                  style={{
                    "--ui-inset": "20px",
                    "--ui-radius-bias": "6px",
                    bottom: "var(--ui-inset)",
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="flex flex-col items-start gap-1.5 min-w-0">
                      <div className="text-sm font-medium text-white/70 leading-none truncate w-full">
                        @{handle}
                      </div>
                      <div className="text-sm text-white/70 leading-none truncate w-full">
                        {status}
                      </div>
                    </div>
                  </div>
